...
Public Class 認定調査票
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        ...
        Dim ymd2AD As String = Util.checkDBNullValue(rs.Fields("Ymd2").Value)
        Dim ymd2Era As String = If(ymd2AD <> "", CInt(ymd2AD.Split("/")(0)).ToString, "")
        Dim ymd2Month As String = If(ymd2AD <> "", CInt(ymd2AD.Split("/")(1)).ToString, "")
        Dim ymd2Day As String = If(ymd2AD <> "", CInt(ymd2AD.Split("/")(2)).ToString, "")
        Dim ymd3AD As String = Util.checkDBNullValue(rs.Fields("Ymd3").Value)
        Dim ymd3Era As String = If(ymd3AD <> "", CInt(ymd3AD.Split("/")(0)).ToString, "")
        Dim ymd3Month As String = If(ymd3AD <> "", CInt(ymd3AD.Split("/")(1)).ToString, "")
        Dim ymd3Day As String = If(ymd3AD <> "", CInt(ymd3AD.Split("/")(2)).ToString, "")
        ...
        End If
        '前回認定
        oSheet.Range("P21").value = ymd2Era
